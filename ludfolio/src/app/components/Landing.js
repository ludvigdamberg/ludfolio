...
function Landing() {
  ...
  return (
    <div>
      <div className=' h-[93vh] w-full p-2 lg:p-20 flex flex-col text-neutral-200 bg-neutral-950'>
        <div className=' flex flex-col '>
          <div className='  p-2 flex flex-col mx-auto h-[50vh] align-bottom justify-end z-30'>
            ...
            <p className='  font-poppins logo font-black text-6xl sm:text-7xl tracking-wider opacity-0 leading-[0.7] text-orange-500'>,</p>
            </div>
            <div className='flex flex-row'>
        ...
        <div className=' h-full flex z-20 '>
          <Link href="/Contact" className=' group py-4 border-2 border-neutral-200 rounded-full px-5 mx-auto text-center my-auto font-bold flex flex-row justify-center items-center '>CONTACT ME <MdOutlineArrowOutward className="group-hover:rotate-45 ease-in-out duration-300 mx-1 "/> </Link>
        </div>
      </div>
