...
function Header() {
  ...
  return (
    <div className='text-neutral-100'>
      <div className='animat h-0 w-full fixed text-sm  top-0 left-0 overflow-hidden flex-col items-center'>
        <div className=' h-full text-center grid grid-rows-3 grid-cols-2'>
          <Link className='group links opacity-0  my-auto flex ml-10' href={"/Projects"}><p className='  mx-2 '> Projects</p></Link>
          <Link className='group links opacity-0  my-auto flex ml-10' href={"/Contact"}> <p className='  mx-2 '> Contact</p></Link>
          <Link className='group links opacity-0  my-auto flex ml-10' href={"/"}> <p className='  mx-2 '> Home</p></Link>
          <a href="assets/CV_eng.pdf" download="CV_eng.pdf" className='group links opacity-0 text-xl  my-auto flex ml-10'> My resume</a>
          <button className='group links opacity-0 my-auto  text-neutral-600 flex ml-10' onClick={() => CollapseMenu()}> <p className=' mx-2'> Close x</p></button>
        </div>
      </div>
      <div className=' w-full grid grid-cols-3 lg:grid-cols-4 h-[6vh] font-light text-sm'>
        <div className='grid grid-cols-3 lg:grid-cols-5 items-center mx-3 text-lg mt-auto'>
          {home && <div className='group relative text-center hidden lg:block '>
            <Link href="/">
              <FaHouse className='  ease-in-out duration-200 m-auto' />
          ...
          <div className='group relative text-center hidden lg:block '>
            <Link href="https://github.com/ludvigdamberg">
              <FaGithub className='  ease-in-out duration-200 m-auto'></FaGithub>
          ...
          <div className='group relative text-center hidden lg:block '>
            <Link href="https://www.linkedin.com/in/ludvigdamberg">
              <FaLinkedin className=' ease-in-out duration-200 m-auto' />
        ...
        <div className='  text-sm  flex flex-row justify-end lg:justify-center text-neutral-400  '>
