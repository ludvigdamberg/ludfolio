...
function Loader() {
  ...
  useLayoutEffect(() => {
    ...
    tl2.to(".heart", { delay:0.5, duration:0.5, y:300 ,ease: "back.in"  })
    tl.fromTo(".load",{y:120}, {delay:0.5, duration: 0.5, y: 0, ease: "back.out", opacity: 1, stagger: 0.1 })
    tl.to(loader.current,{ height: 0, duration: 0.5,ease: "power3.in"})
  ...
  return (
    <div ref={loader} className=' h-screen w-screen bg-neutral-950 text-neutral-200 fixed top-0 left-0 z-50 text-5xl font-bold justify-center items-center flex overflow-hidden'>
      <div className='flex h-auto'>
        <div className=' flex flex-col font-black md:text-9xl text-5xl font-poppins border rounded-l-xl md:h-[250px] md:w-[250px] overflow-hidden'>
