    ...
    return (<>
        {loaded &&
            <div className=' w-full h-auto flex flex-col bg-neutral-950 text-neutral-100 font-light'>
                ...
                <div className=' flex flex-col w-full h-auto p-5 md:p-20 mt-5 md:mt-0 bg-neutral-950'>
                    <div className='flex mx-auto'>
                        <button onClick={() => handlePrev()} className=' py-2 px-2 rounded-full border my-auto mx-2 md:mx-10 hover:scale-105 ease-in-out duration-200'>
                        ...
                        <button onClick={() => handleNext()} className=' py-2 px-2 rounded-full border my-auto mx-2 md:mx-10 hover:scale-105 ease-in-out duration-200'>
                    ...
                    <div className='flex flex-col w-full h-full p-5'>
                        ...
                        <p className=' md:text-xl mx-auto text-neutral-300 tracking-wide mt-5'>{project.description}</p>
                        <div className=' mt-5 text-sm tracking-wider leading-relaxed md:text-base lg:px-40 lg:mx-40 text-center'>
                            <PortableText value={project.content} />
                        </div>
                    </div>
                    <div className='flex md:flex-row flex-col p-5 px-10 md:px-2 items-center border rounded-xl mx-auto mt-5 h-auto my-10'>
                        <div className=' md:text-xl text-sm mt-5 flex md:flex-row flex-col items-center '>Tech Stack: {project.tech.map((t,index) => <p key={index} className=' my-auto text-sm border rounded-2xl mt-2 md:mt-0 px-1 md:px-4 py-1 text-yellow-500 mx-1'>{t} </p>)}</div>
                        <p className=' md:text-xl text-center text-neutral-300 tracking-wide mt-5'></p>
