...
function page() {
  ...
  */
  ...
  return (
    <div className=' h-[400vh] w-full flex flex-col text-neutral-200 bg-neutral-950 '>
      <div className='h-screen w-full flex'></div>
      <div className='pin h-screen w-full grid grid-cols-2 p-14 '>
        <div className=' w-full h-full grid grid-cols-2'>
          <div className=' flex w-full h-full flex-col p-10'>
            <p className=' font-rubik font-black text-5xl mt-20 text-violet-500'>ABOUT ME</p>
          ...
          <div className=' flex w-full h-full flex-col p-10'>
            <p className=' font-rubik font-black text-5xl mt-52 text-lime-500'>AND...</p>
        ...
        <div className=' w-full h-full grid grid-cols-2 bg-indigo-950 '>
